...
public class VaccineServletSimple3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			request.setAttribute("AvgProtectionBynameList", vaccinesimple3service.avgProtectionByType());
		...
		request.getRequestDispatcher("/jsps/simple_result/simple1.jsp").forward(request, response);
