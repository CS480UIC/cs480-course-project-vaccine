...
public class findbyvaccine_nameServlet extends HttpServlet {
 ...
 protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  ...
  try {
   request.setAttribute("vaccineList", vaccineservice.findByvaccine_name(info.get(1)));
  ...
  try {
   List<Object> li = vaccineservice.findByvaccine_name(info.get(1));
  ...
  request.getRequestDispatcher("/jsps/vaccine/q1_list_vaccine.jsp").forward(request, response);
