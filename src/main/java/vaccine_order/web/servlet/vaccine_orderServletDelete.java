...
public class vaccine_orderServletDelete extends HttpServlet {
 private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public vaccine_orderServletDelete() {
        super();
 ...
 protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  ...
  try {
   vaccine_orderservice.delete(Integer.parseInt(info.get(1)), info.get(2));
   
   response.sendRedirect( request.getContextPath() + "/vaccine_orderServletFindAll");
